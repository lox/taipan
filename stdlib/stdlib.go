...
// Package stdlib provides the bootstrap code to wire in Taipan's minimal
// runtime modules into a context and VM.
package stdlib
...
import (
	...
	_ "github.com/lox/taipan/stdlib/builtin"
	_ "github.com/lox/taipan/stdlib/sys"
)
...
func (ctx *context) ModuleInit(impl *py.ModuleImpl) (*py.Module, error) {
	...
	if impl.Code == nil && len(impl.CodeBuf) > 0 {
		return nil, py.ExceptionNewf(py.ImportError, "bytecode module loading is disabled")
	}
...
func (ctx *context) ResolveAndCompile(pathname string, opts py.CompileOpts) (py.CompileOut, error) {
	...
	err = resolveRunPath(pathname, opts, tryPaths, func(fpath string) (bool, error) {
		...
		default:
			return false, py.ExceptionNewf(py.ImportError, "unsupported module source %q", fpath)
		}
